...
public class MainListAdapter6 extends ArrayAdapter<Category>{

	public ListData data;
	public MainListAdapter adapter;
	public MainListAdapter6 adapter2;
	...
	public MainListAdapter6(Context context, int textViewResourceId, ArrayList<Category> items) {
