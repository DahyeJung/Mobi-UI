	...
	public void onCreate(Bundle savedInstanceState) {
		...
		menuRight.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Main_my.this,Setting.class);
		...
		Leftdata = new ListData("관심",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("최근",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("저장",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
