...
public class Main_genre extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		menuRight.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Main_genre.this,Setting.class);
		...
		Leftdata = new ListData("판타지",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("드라마",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("일상",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("액션",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("순정",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("감성",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
		Leftdata = new ListData("스릴러",R.drawable.date_arrow);
		LeftArray.add(Leftdata);
	...
	private OnItemClickListener itemClickListenerofDaysOfWeek = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> adapterView, View clickedView, int pos,
			...
			v = l.inflate(R.layout.main_left_genre, null);
			...
			if(pos == 0){
				...
				Rightadapter.notifyDataSetChanged();
				Rightlist.setAdapter(Rightadapter);
				Toast toast = Toast.makeText(Main_genre.this, "해당 작품이 없습니다.", Toast.LENGTH_LONG);
				toast.show();
