...
public class MainListAdapter4 extends ArrayAdapter<Category>{

	public ListData data;
	public MainListAdapter adapter;
	public MainListAdapter4 adapter2;
	...
	public MainListAdapter4(Context context, int textViewResourceId, ArrayList<Category> items) {
