...
public class MainListAdapter7 extends ArrayAdapter<Category>{

	public ListData data;
	public MainListAdapter adapter;
	public MainListAdapter7 adapter2;
	...
	public MainListAdapter7(Context context, int textViewResourceId, ArrayList<Category> items) {
