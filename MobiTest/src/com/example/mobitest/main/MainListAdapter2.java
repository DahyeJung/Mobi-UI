...
public class MainListAdapter2 extends ArrayAdapter<Category>{

	public ListData data;
	public MainListAdapter adapter;
	public MainListAdapter2 adapter2;
	...
	public MainListAdapter2(Context context, int textViewResourceId, ArrayList<Category> items) {
