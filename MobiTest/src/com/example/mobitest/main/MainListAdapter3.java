...
public class MainListAdapter3 extends ArrayAdapter<Category>{

	public ListData data;
	public MainListAdapter adapter;
	public MainListAdapter3 adapter2;
	...
	public MainListAdapter3(Context context, int textViewResourceId, ArrayList<Category> items) {
