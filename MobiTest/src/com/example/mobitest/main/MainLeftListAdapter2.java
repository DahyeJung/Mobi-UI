...
public class MainLeftListAdapter2 extends ArrayAdapter<ListData>{

	private ArrayList<ListData> items;

	public MainLeftListAdapter2(Context context, int textViewResourceId, ArrayList<ListData> items) {
