...
public class MainListAdapter9 extends ArrayAdapter<Category>{

	public ListData data;
	public MainListAdapter adapter;
	public MainListAdapter9 adapter2;
	...
	public MainListAdapter9(Context context, int textViewResourceId, ArrayList<Category> items) {
