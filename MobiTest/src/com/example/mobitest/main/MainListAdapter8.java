...
public class MainListAdapter8 extends ArrayAdapter<Category>{

	public ListData data;
	public MainListAdapter adapter;
	public MainListAdapter8 adapter2;
	...
	public MainListAdapter8(Context context, int textViewResourceId, ArrayList<Category> items) {
